...
void main() {
  group('Model Note Unit Tests', () {
    ...
    test('copyWith memperbarui nilai dengan benar', () {
      final note = Note(
        id: 1,
        title: 'Awal',
        body: 'Isi awal',
      ...
      final updated = note.copyWith(title: 'Revisi', dirty: true);
      expect(updated.id, 1);
      expect(updated.title, 'Revisi');
      expect(updated.body, 'Isi awal');
      expect(updated.dirty, isTrue);
    });
  });

  group('Riverpod Provider Tests dengan Fake Repository', () {
